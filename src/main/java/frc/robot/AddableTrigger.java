...
//  * certain sensor input). For this, they only have to write the {@link AddableTrigger#get()} method to get
//  * the full functionality of the Trigger class.
//  *
//  * <p>This class is provided by the NewCommands VendorDep
//  */
// public class AddableTrigger implements BooleanSupplier {
//   private final BooleanSupplier m_isActive;
//   private final XboxController m_xController;
//   private final int m_numberOfControllers;

//   public AddableTrigger(int numberOfControllers, XboxController xboxController, BooleanSupplier isActive) {
//       m_isActive = isActive;
//       m_xController = xboxController;
//       m_numberOfControllers = numberOfControllers;
//   }

//   public AddableTrigger add(String name, XboxButton xboxButton) {
//       return new AddableTrigger(m_numberOfControllers, m_xController, new JoystickButton(m_xController, Controls.buttonToButtonNumber(xboxButton)));
//   }

//   public AddableTrigger add(String name, XboxDPAD xboxDPAD) {
//       return new AddableTrigger(m_numberOfControllers, m_xController, () -> m_xController.getPOV() == Controls.dpadToHatDegrees(xboxDPAD));
//   }

//   public AddableTrigger add(String name, XboxTrigger xboxTrigger) {
//     return new AddableTrigger(m_numberOfControllers, m_xController, () -> m_xController.getRawAxis(Controls.triggerToTriggerNumber(xboxTrigger)) < ControllerConstants.kTriggerThreshold);
// }

//   public Controller finish() {
//     //   return new Controller(m_numberOfControllers);
//   }
// //   /**
...
// //    */
// //   public AddableTrigger(BooleanSupplier isActive) {
// //     m_isActive = isActive;
// //   }

// //   /**
// //    * Creates a new trigger that is always inactive. Useful only as a no-arg constructor for
// //    * subclasses that will be overriding {@link AddableTrigger#get()} anyway.
// //    */
// //   public AddableTrigger() {
// //     m_isActive = () -> false;
// //   }
...
//    *
//    * <p>Functionally identical to {@link AddableTrigger#getAsBoolean()}.
//    *
...
//    * <p>This method will be called repeatedly a command is linked to the Trigger.
//    *
//    * <p>Functionally identical to {@link AddableTrigger#get()}.
//    *
//    * @return whether or not the trigger condition is active.
//    */
//   @Override
...
//    */
//   public AddableTrigger whenActive(final Command command, boolean interruptible) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whenActive(final Command command) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whenActive(final Runnable toRun, Subsystem... requirements) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whileActiveContinuous(final Command command, boolean interruptible) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whileActiveContinuous(final Command command) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whileActiveContinuous(final Runnable toRun, Subsystem... requirements) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whileActiveOnce(final Command command, boolean interruptible) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whileActiveOnce(final Command command) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whenInactive(final Command command, boolean interruptible) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whenInactive(final Command command) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger whenInactive(final Runnable toRun, Subsystem... requirements) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger toggleWhenActive(final Command command, boolean interruptible) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger toggleWhenActive(final Command command) {
...
//    * @return this trigger, so calls can be chained
//    */
//   public AddableTrigger cancelWhenActive(final Command command) {
...
//    */
//   public AddableTrigger and(AddableTrigger trigger) {
//     return new AddableTrigger(m_numberOfControllers, m_xController, () -> get() && trigger.get());
//   }
...
//    */
//   public AddableTrigger or(AddableTrigger trigger) {
//     return new AddableTrigger(m_numberOfControllers, m_xController, () -> get() || trigger.get());
//   }
...
//    */
//   public AddableTrigger negate() {
//     return new AddableTrigger(m_numberOfControllers, m_xController, () -> !get());
//   }
...
//    */
//   public AddableTrigger debounce(double seconds) {
...
//    */
//   public AddableTrigger debounce(double seconds, Debouncer.DebounceType type) {
//     return new AddableTrigger(
