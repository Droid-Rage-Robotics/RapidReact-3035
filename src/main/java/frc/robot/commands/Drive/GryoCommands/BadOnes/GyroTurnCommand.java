...
public class GyroTurnCommand extends SequentialCommandGroup {
    public GyroTurnCommand(double angle, double speed, Drive2 drive) {
        ...
        while (!(drive.leftEncoder.get() > moveCounts - 200 && drive.leftEncoder.get() < moveCounts + 200)) {
